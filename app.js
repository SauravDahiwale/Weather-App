const API_KEY="34265474b7e6b3548eb511eadc4cbf43";
...
const getCitiesUsingGeoLocations= async (searchText)=>{
    const response= await fetch(`http://api.openweathermap.org/geo/1.0/direct?q=${searchText}&limit=6&appid=${API_KEY}`);
...
const loadHourlyForecast =({main: { temp : tempNow},weather: [{icon:iconNow}]},hourlyForecast) =>{
    ...
    <img class="icon" src="${createIconUrl(iconNow)}" alt="icon for the forecast">
